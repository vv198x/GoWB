...
func main() {
	...
	/*
		...
		•	Если текущая позиция ниже 1 (т.е. <=10):
		o	  Уменьшите ставку на заранее определенный шаг, чтобы снизить позицию.
		•	Если текущая позиция находится в диапазоне 1-10:
		o	  Оставьте ставку без изменений, чтобы сохранить позицию в целевом диапазоне.
